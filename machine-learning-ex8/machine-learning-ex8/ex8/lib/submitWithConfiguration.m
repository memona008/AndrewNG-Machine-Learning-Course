...
function response = submitParts(conf, email, token, parts_1)
  body = makePostBody(conf, email, token, parts_1);
...
function body = makePostBody(conf, email, token, parts_1)
  bodyStruct.assignmentSlug = conf.assignmentSlug;
  bodyStruct.submitterEmail = email;
  bodyStruct.secret = token;
  bodyStruct.parts = makePartsStruct(conf, parts_1);

  opt.Compact = 1;
  body = savejson('', bodyStruct, opt);
end

function partsStruct = makePartsStruct(conf, parts_1)
  for part = parts_1
    partId = part{:}.id;
...
function showFeedback(parts_1, response)
  fprintf('== \n');
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function submissionUrl_1 = submissionUrl()
  submissionUrl_1 = 'https://www-origin.coursera.org/api/onDemandProgrammingImmediateFormSubmissions.v1';
end
